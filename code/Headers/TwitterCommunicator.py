...
class TwitterCommunicator(object):
    ...
    twitterObject = None #Central twitter object of class
    my_friends_all = None #Set of User's friends
    my_friends_filtered = list() #Set of actual friends (excludes celebrites, pages etc)
#-----------------------------------------------------------------------------------------------------------------------------------#
